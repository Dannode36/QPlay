...
namespace ImGui
{
    ...
    static void processCurrentFrame(FrameIndexType* frame, ImGuiNeoSequencerInternalData& context)
    {
        ...
        const auto hovered = ItemHoverable(pointerRect, GetCurrentWindow()->GetID("##_top_selector_neo"), 0); //FIX: 0 is a temporary fix
    ...
    static bool createKeyframe(int32_t* frame)
    {
        ...
        bool hovered = ItemHoverable(bb, id, 0); //FIX: 0 is a temporary fix
...
//
        ...
        *end = endFrameVal;
        ...
        const bool hovered = ItemHoverable(bb, GetCurrentWindow()->GetID("##zoom_slider"), 0); //FIX: 0 is a temporary fix
